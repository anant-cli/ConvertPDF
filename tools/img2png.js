...
function renderimg2png(container) {
    ...
    area.innerHTML = `
        ...
        <div style="display: flex; gap: 1rem; flex-wrap: wrap; margin-bottom: 1.5rem;">
            ...
            <div style="display: flex; align-items: center; color: var(--text-muted); font-size: 0.9rem;" id="imgPngStats">
        ...
        <div style="display: grid; grid-template-columns: 1fr; gap: 1.5rem; margin-top: 1.5rem;">
            <div class="preview-box" style="margin: 0;">
                ...
                <div style="text-align: center;">
                    ...
                    <div id="pngPlaceholder" style="padding: 2rem; color: var(--text-muted);">Converted image will appear here</div>
                </div>
            </div>
        </div>
