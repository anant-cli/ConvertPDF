...
async function renderdocx2pdf(container) {
    try {
        ...
        <div id="docxDropZone" class="drop-zone" style="border: 2px dashed rgba(255,255,255,0.1); padding: 2rem; text-align: center; border-radius: var(--r-md); background: var(--bg-input); cursor: pointer; transition: all 0.2s ease; margin-bottom: 1rem;">
    ...
    `;
        ...
        <style>
            ...
            @media print { body { margin: 0; padding: 0; background: var(--bg-surface); } }
        </style>
    `;
